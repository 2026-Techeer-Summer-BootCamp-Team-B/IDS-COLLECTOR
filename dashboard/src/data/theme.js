...
export const CHART_COLORS = {
  dark: {
    ...
    // 쓰는 은은한 회색)를 그대로 쓰니 "너무 밝다"는 2026-07-17 피드백으로
    // #33364A까지 낮췄었는데, 그러면 bg(#030305) 대비 명도 대비가 1.5~1.7:1
    // 밖에 안 나와서(WCAG 그래픽 객체 최소 기준 3:1에 한참 못 미침) 이번엔
    // "거의 안 보인다"는 반대 피드백(2026-07-17 후속) - bg/surface/surfaceAlt
    // 전부에서 3:1 이상 나오는 #666C96(각각 4.07/3.83/3.56:1)으로 다시 올림.
    // faint(#5A6288, bg 대비 3.47:1)보다는 여전히 어둡게 유지해서 "죽은" 느낌은
    // 유지하되, 완전히 안 보이진 않게 하는 균형점.
    donutDim: "#666C96",
    fg: "#F2F5FF",
    critical: "#FF1F4B",
    high: "#FF7A18",
