...
각 로그를 따로 보면 사소해 보이는 이 흔적들을, **SENTINEL-OPS**는
...
![SENTINEL-OPS Page Demo](docs/images/DualMonitorTour.gif)

---

## 3. Login Page

서비스 소개 온보딩 영상이 끝나면 로그인 화면으로 전환됩니다. 
...
> <img width="7260" height="4470" alt="image" src="https://github.com/user-attachments/assets/4fb861d6-9fe6-4efe-8c51-181820bd70f0" />
